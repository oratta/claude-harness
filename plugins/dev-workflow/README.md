...
| `references/subagent-waiting.md` | サブエージェントが長時間処理の完了を待つ方法の契約（完了待ちでターンを終えない・完了シグナルの経路別定義・前景ポーリングの雛形・待ち値 540000 ms・総待ちの上限 3 回 = 27 分）。develop の W / R1 / G の指示書と pr-review-gate スキルが参照する |
