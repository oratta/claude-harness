...
#   - longrun & lr versions are 6.0.0 across the 2 sync locations
...
@test "legacy: longrun version is 6.0.0 in plugin.json and marketplace plugins[]" {
...
@test "legacy: lr version is 6.0.0 in plugin.json and marketplace plugins[] (no bump miss)" {
