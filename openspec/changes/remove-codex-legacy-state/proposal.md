...
- `codex-worker-concurrency`: 台帳の account slot、cwd 排他、reap の capability 全体を廃止する。
- `codex-develop-continuation`: run-dir と継続記録 v1/v2 の capability 全体を廃止する。

## Impact

- 実装: `plugins/dev-workflow/scripts/codex-worker.py`、`plugins/dev-workflow/scripts/codex-develop.py`
- 文書: `plugins/dev-workflow/scripts/CODEX-WORKER.md`、`plugins/dev-workflow/docs/codex-develop.md`、`plugins/dev-workflow/references/codex-develop.md`
