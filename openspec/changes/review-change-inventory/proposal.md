...
- Define one revision-safe, repository-wide search-command and hit-table contract shared by the first-pass reconciliation table and the first stage of pr-review-gate triage step 3, while keeping step 3's post-fix second stage separate.
