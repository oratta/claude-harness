...
- [ ] 4.2 `grep -rn "test_codex_worker.py\|test_codex_\*.py\|-p test_codex.py" --include='*.md' plugins scripts docs README.md` と `grep -n -- "-p test_codex" plugins/*/tests/test_*.py` がどちらもヒット 0 件であることを確認する
