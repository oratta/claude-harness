...
- [x] 7.7 (3b) で archive する（`/opsx:archive cost-ledger-gate-report`。specs の `cost-ledger-pricing`・`cost-ledger-attribution` の MODIFIED と、新 capability `cost-ledger-gate-report` を正本へ同期する）
