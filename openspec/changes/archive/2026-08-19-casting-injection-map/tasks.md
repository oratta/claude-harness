...
## 5. 主フィードバック反映（2026-08-19・レビュー通過後）

- [x] 5.1 injection.md に大原則（注入のサブエージェント限定）・論点相談タイミング（9分類化）・人格規約を追記し、#127 を起票・参照
- [x] 5.2 spec に「注入のサブエージェント限定と人格規約」Requirement を追加し、9分類表記を全ファイルで同期
- [x] 5.3 bats に語彙9分類・大原則・人格規約の検査を追加して green を確認
