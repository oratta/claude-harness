...
//
// 埋め込みポイント（exec が置換する）:
//   /Users/oratta/.claude/plugins/marketplaces/oratta-claude-harness/_longruns/2026-07-03_plugin-review-fixes/plan.md            plan.md の絶対パス
...
const verdict = await agent(
  `Build Contract レビュー: /Users/oratta/.claude/plugins/marketplaces/oratta-claude-harness/_longruns/2026-07-03_plugin-review-fixes/plan.md の Changes 分解を評価してください。` +
  `プロジェクトルートは /Users/oratta/.claude/plugins/marketplaces/oratta-claude-harness です。` +
